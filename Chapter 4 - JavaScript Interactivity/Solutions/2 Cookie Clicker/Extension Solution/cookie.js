...
// CREATE AUTO CLICKER FUNCTION //
// This function will create an auto clicker. It uses the setInterval function to run "addCookiePoint" every second
function createAutoClicker() {
  setInterval(addCookiePoint,1000);
}
...
cookieElement.addEventListener("click",createAutoClicker); // Using "addEventListener" means that adding a second event listener will not replace the first
